...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '6b3be8ba80be47e6aeae688d2ae8e1db,en:7c1d570661754c8fbc568e00a01fd70e',  // 17改动，6b3be8ba80be47e6aeae688d2ae8e1db。
  PSEUDO_STATIC: process.env.NEXT_PUBLIC_PSEUDO_STATIC || false, // 伪静态路径，开启后所有文章URL都以 .html 结尾。
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 5, // 更新内容缓存间隔 单位(秒)；即每个页面有5秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  THEME: process.env.NEXT_PUBLIC_THEME || 'heo', // 17改动，heo。当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  THEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH || false, // 是否显示切换主题按钮
  LANG: process.env.NEXT_PUBLIC_LANG || 'zh-CN', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  SINCE: process.env.NEXT_PUBLIC_SINCE || 2021, // e.g if leave this empty, current year will be used.
  APPEARANCE: process.env.NEXT_PUBLIC_APPEARANCE || 'dark', // 17改动，dark。['light', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题自动夜间模式
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Steve17', // 17改动，Steve17。您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '热爱折腾', // 17改动，热爱折腾。作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wow17.com', // 17改动，https://wow17.com。网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,效率,产品,省钱,生活', // 17改动，博客,效率,产品,省钱,生活。网站关键词 英文逗号隔开
  ...
  POSTS_SORT_BY: process.env.NEXT_PUBLIC_POST_SORT_BY || 'date', // 17改动，date。排序方式 'date'按时间,'notion'由notion控制
  ...
  // 鼠标跟随特效
  MOUSE_FOLLOW: process.env.NEXT_PUBLIC_MOUSE_FOLLOW || true, // 17改动，开关
  // 这两个只有在鼠标跟随特效开启时才生效
  ...
  // 悬浮挂件
  WIDGET_PET: process.env.NEXT_PUBLIC_WIDGET_PET || false, // 17改动，false。是否显示宠物挂件
  WIDGET_PET_LINK:
  ...
  ADSENSE_GOOGLE_SLOT_IN_ARTICLE:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_IN_ARTICLE || '', // 17改动，清空。Google AdScene>广告>按单元广告>新建文章内嵌广告 粘贴html代码中的data-ad-slot值
  ADSENSE_GOOGLE_SLOT_FLOW:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_FLOW || '', // 17改动，清空。Google AdScene>广告>按单元广告>新建信息流广告
  ADSENSE_GOOGLE_SLOT_NATIVE:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_NATIVE || '', // 17改动，清空。Google AdScene>广告>按单元广告>新建原生广告
  ADSENSE_GOOGLE_SLOT_AUTO:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '', // 17改动，清空。Google AdScene>广告>按单元广告>新建展示广告 （自动广告）
