const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://wow17.com' }, // 17改动，复制粘贴。
    { title: '重建并迁移中，敬请期待', url: 'https://wow17.com' } // 17改动，复制粘贴。
  ],
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: '分享方法', // 17改动，复制粘贴。
  HEO_HERO_TITLE_2: '与思维认知', // 17改动，复制粘贴。
  HEO_HERO_TITLE_3: 'WOW17.com', // 17改动，复制粘贴。
  HEO_HERO_TITLE_4: '新版上线', // 17改动，复制粘贴。
  HEO_HERO_TITLE_5: '持续更新', // 17改动，复制粘贴。
  HEO_HERO_TITLE_LINK: 'https://wow17.com', // 17改动，复制粘贴。
  ...
  // 个人资料底部按钮
  HEO_INFO_CARD_URL1: '/about', // 17改动，复制粘贴。
  ...
  HEO_SOCIAL_CARD_TITLE_1: '留言板', // 17改动，复制粘贴。
